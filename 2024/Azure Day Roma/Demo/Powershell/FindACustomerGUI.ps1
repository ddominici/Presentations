<#
 ...
 #  visualizza il risultato in una combo box e consente di scegliere
 #  il cliente per nome e visualizzarne i dati in delle label.
 #>
...
$lblCountry.Text = ""
$lblCountry.Location  = New-Object System.Drawing.Point(10,140)
$lblCountry.AutoSize = $true
$lblCountry.Font = $font
