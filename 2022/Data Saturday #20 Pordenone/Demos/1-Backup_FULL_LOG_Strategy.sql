...
USE master
GO
RESTORE DATABASE AdventureWorks2019 FROM DISK = 'C:\DataSat20\Demos\Backups\Adv2019_Base.BAK' WITH REPLACE, NORECOVERY
RESTORE LOG AdventureWorks2019 FROM DISK = 'C:\DataSat20\Demos\Backups\Adv2019_Log.BAK' WITH NORECOVERY
RESTORE LOG AdventureWorks2019 FROM DISK = 'C:\DataSat20\Demos\Backups\Adv2019_Log2.trn' WITH NORECOVERY
RESTORE LOG AdventureWorks2019 FROM DISK = 'C:\DataSat20\Demos\Backups\Adv2019_Log3.trn' WITH NORECOVERY
