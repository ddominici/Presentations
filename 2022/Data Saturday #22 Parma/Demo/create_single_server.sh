...
az postgres server create -l westeurope -g "RG-DD-POSTGRESQL" -n pgdd02 -u danilo -p "P@ssw0rd!" \
    --sku-name B_Gen5_1 --ssl-enforcement Enabled --minimal-tls-version TLS1_0 --public-network-access Enabled \
    --backup-retention 10 --geo-redundant-backup Disabled --storage-size 51200 \
